        ...
        if now > self.t_next:
            ...
            if self.enc_left == None:
                ...
                if denta_right>1000:
                    ...
                    denta_right = denta_right + 2000    
                d_left = denta_left / self.ticks_meter
                d_right = denta_right / self.ticks_meter
...
#            print(self.d_left)
            ...
            if th_imu >= math.pi : 
                ...
                th_imu = th_imu + 2*math.pi
            print("delta imu",th_imu)

                #print("delta_th_imu",th_imu)
                #print("delta theta enc ",th) 
                #print("Yaw",self.yaw)
            ...
            if (d != 0):
                ...
                self.x = self.x + ( cos( self.th_imu ) * x - sin( self.th_imu ) * y )
                self.y = self.y + ( sin( self.th_imu ) * x + cos( self.th_imu ) * y )
...
#           print(self.x, self.y)
            if(th != 0):
                ...
                print("Yaw",self.yaw)
                print("Do lech:", self.th - self.th_imu)
                print("-------------------------") 
           # print("yaw:",self.yaw)
            ...
            quaternion.x = 0.0
            quaternion.y = 0.0
            quaternion.z =   sin( self.th_imu/2 ) # can not use self.orien_z   
            quaternion.w =   cos( self.th_imu/2 )  # self.orien_w  
            ...
            #odom.twist.twist = Twist(Vector3(self.dx, 0, 0), Vector3(0, 0, self.dr))
