...
#            print(self.d_left)
            ...
            quaternion.x = 0.0
            quaternion.y = 0.0
            quaternion.z =  sin( self.th_imu/2 ) # self.orien_z     # or using orientation_q.z
            quaternion.w =  cos( self.th_imu/2 )  #self.orien_w     # or using orientation_q.w 
