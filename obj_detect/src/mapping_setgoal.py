...
class RosTensorFlow():
    def __init__(self):
        ...
        self.list_obj = ["water bottle","crash helmet","beer glass"]
    def callback(self, image_msg):
        ...
        if score > self.score_threshold:
            ...
            if human_string.split(',')[0] in self.list_obj:
                ...
                rospy.loginfo(str(human_string.split(',')[0]))
                rospy.loginfo(len(res)) 
                with open('/home/philong/my_project/src/obj_detect/src/param_yaml/data_3.yaml', 'w') as yaml_file:            
